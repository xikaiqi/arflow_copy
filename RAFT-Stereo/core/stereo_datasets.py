...
class SceneFlowDatasets(StereoDataset):
    def __init__(self, aug_params=None, root='/media/sde/datasets/SceneFlow', dstype='frames_finalpass', things_test=False):
    ...
    def _add_things(self, split='TRAIN'):
        ...
        root = osp.join(self.root, 'flyingthings3d_final')
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='/home/xikaiqi/workspace/datasets/KITTI', image_set='training'):
